...
<script>
import ToolBar from './containers/ToolBar'  // 最顶端的工具栏
import Sketchpad from './containers/Sketchpad'  // 最中间的画布
import PanelLeft from './containers/PanelLeft'  // 左侧空间选择面板
import PanelRight from './containers/PanelRight'  // 右侧属性配置面板
import PreviewModel from './containers/PreviewModel'  // 工具栏点击预览后出现的面板
import ContextMenu from './containers/ContextMenu'  // 右击画布弹出的菜单
import AboutXFC from './containers/AboutXFC'  // 工具栏最右 -> 关于 XFC 弹出的窗口
import ShortcutList from './containers/ShortcutList'  // 工具栏最右 -> 快捷键列表 弹出的窗口
import History from './containers/History'  // 工具类 -> 历史记录 弹出的窗口
